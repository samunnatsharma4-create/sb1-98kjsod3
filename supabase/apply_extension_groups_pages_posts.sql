-- =============================================================================
-- NepLink — Groups, Community Pages, scoped posts + RLS (standalone script)
-- =============================================================================
-- Use: Supabase Dashboard → SQL Editor → paste & run this whole file.
-- BEFORE THIS: run `migrations/20260502080003_create_neplink_schema.sql` once
--               (creates profiles, posts, messages, notifications, …).
-- OPTIONAL:     `migrations/20260502120000_storage_images_bucket.sql` for uploads.
--
-- Fixes "could not find table community_pages/groups/group_members/page_followers"
